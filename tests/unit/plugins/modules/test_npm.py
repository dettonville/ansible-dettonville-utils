...
from ansible_collections.dettonville.utils.tests.unit.compat.mock import call, patch
from ansible_collections.dettonville.utils.plugins.modules import npm
from ansible_collections.dettonville.utils.tests.unit.plugins.modules.utils import AnsibleExitJson, ModuleTestCase, set_module_args
...
class NPMModuleTestCase(ModuleTestCase):
    ...
    def setUp(self):
        ...
        ansible_module_path = "ansible_collections.dettonville.utils.plugins.modules.npm.AnsibleModule"
